    ...
    <div class="container">
       ...
       <div class="container" style="background-color:black">
        <div class="content-container" style="background-color:black">
                ...
                <h1 style="margin-top:15px; text-align:center" class="movie-list-title ">Friend Request</h1>
                    ...
                    <div class="movie-list">
                        ...
                        $name= $row['name'];
                            ...
                            <a href="view_profile.php?title='.$value.'"><input class="movie-list-item-button" type="submit" value="View"> </a>
                            <a href="friends.php?acceptrequest='.$value.'"> <input class="movie-list-item-button1" name="addfriend" type="submit" value="Accept"> </a>
                            <a href="friends.php?cancel='.$value.'"> <input class="movie-list-item-button2" name="X" type="submit" value="X"> </a>
            ...
            <div class="movie-list-container" style="background-color:black">
                <h1 style="margin-top:15px; text-align:center" class="movie-list-title ">Friend List</h1>
                    <div class="movie-list-wrapper">
                    <div class="movie-list">
                        ...
                        $name= $row['name'];
                            ...
                            <a href="friends.php?unfriend='.$value.'"> <input class="movie-list-item-button2" name="X" type="submit" value="Unfriend"> </a>
                ...
                <h1 style="margin-top:15px; text-align:center" class="movie-list-title ">Sent Request</h1>
                    ...
                    <div class="movie-list">
                        ...
                        $name= $row['name'];
                            ...
                            <img class="movie-list-item-img" src="img/'.$img.'" alt="">
                            <span class="movie-list-item-title">'.$name.'</span>
                            <a href="friends.php?title='.$value.'"> <input class="movie-list-item-button" type="submit" value="View Profile"> </a>

                           <a href="friends.php?cancelsr='.$value.'"> <input class="movie-list-item-button2" name="X" type="submit" value="X"> </a>
