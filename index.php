...
if ($result->num_rows > 0) {
    ...
    $sql = "INSERT INTO `user`(`name`, `email`, `password`,`image`) VALUES ('$name','$email','$password','profile.jpg')";
    ...
    <div class="container content">
        ...
        <div class="container">
            <div class="content-container">
                ...
                <button class="featured-button" onclick="loginopenForm()">Get Recommend</button>
       ...
       <!-- signup -->
            <div class="form-popup" id="signupmyForm">
                <form action="" class="form-container" method="POST">
                     <h2 style="color:blue; text-align: center;">Signup Form</h2>
                    <hr>
                    <div class="field">
